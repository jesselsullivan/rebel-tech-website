  ...
  return <section className="page">
    <div className="container">
      ...
      <div className="row g-4 contact-grid">
        <div className="col-lg-5"><div className="contact-info"><h2>Let's talk tech.</h2><p>For the fastest response, call or start a service request.</p><a className="big-phone" href={`tel:${site.phone}`}>{site.phoneDisplay}</a><div className="info-row"><b>Location</b><span>{site.city}<br />{site.serviceArea}</span></div><div className="info-row"><b>Hours</b><span>Mon–Fri: 9 AM–4 PM<br />Saturday: 9 AM–2 PM<br />Sunday: Closed</span></div><div className="info-row"><b>Customer Portal</b><a href={site.repairShopr.portalUrl} target="_blank" rel="noreferrer">rebeltech.repairshopr.com ↗</a></div></div></div>
